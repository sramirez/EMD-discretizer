 ...
 * @author Modified by Alberto Fern�ndez (University of Granada) 03/09/2009
...
public class myDataset {
  ...
  /**
   * It gets the dataset as a instance set object (useful for use the dataset in other methods)
   * @return InstanceSet the dataset as a instance set object
   */
  public InstanceSet asInstanceSet() {
	  return this.IS;
  }
  ...
  */
  ...
  /**
   * It copies the header of the dataset
   * @return String A string containing all the relationname data-set information
   */
  public String copyRelationName() {
    String p = new String("");
    p = "@relation " + Attributes.getRelationName() + "\n";
    return p;
  }
  ...
  /**
   * It copies an attribute of the dataset
   * 
   * @param pos	Position of the attribute of the dataset we are copying
   * @return String A string containing all the attribute of the data-set information
   */
  public String copyAttribute (int pos) {
    String p = new String("");
    p = Attributes.getInputAttribute(pos).toString()+"\n";
    return p;
  }
  
  /**
   * It copies the output attributes of the dataset
   * @return String A string containing all the output attributes data-set information
   */
  ...
  /**
   * It copies the end of the header of the dataset
   * @return String A string containing all the end of the header data-set information
   */
  public String copyEndOfHeader() {
    String p = new String("");
    p += Attributes.getInputHeader() + "\n";
    p += Attributes.getOutputHeader() + "\n";
    p += "@data\n";
  ...
  /**
   * Obtains the string corresponding to a nominal value for a given attribute
   * 
   * @param att	Attribute corresponding to the nominal value given
   * @param value	Integer that represents a nominal value
   * @return	string representation of the nominal value given
   */
  public String getNominalValueAttribute (int att, int value) {
	  if (this.getTipo(att) == NOMINAL) {
		  return Attributes.getInputAttribute(att).getNominalValue(value);
	  }
	  else {
		  System.err.println("The given attribute is not a nominal attribute");
		  System.exit(-1);
		  return "";
	  }
  }
